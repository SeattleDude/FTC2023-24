...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        ...
        public double par0YTicks = -1011.7781433801083; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 914.7362676194884; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2182.1147727836264; // x position of the perpendicular encoder (in tick units)
    }
